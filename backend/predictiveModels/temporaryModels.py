...
class DynamicModel():
    ...
    roughness_class = [2, 2.5, 3, 3.5, 2, 2.5, 3, 3.5, 2, 2.5, 3, 3.5, 2, 2.5, 3, 3.5, 2, 2.5, 3, 3.5, 2, 2.5, 3, 3.5, 2, 2.5, 3, 3.5, 2, 2.5, 3, 3.5, 2, 2.5] # baked into the spreadsheet, at 'Course info'!$Q$21:$R$30
